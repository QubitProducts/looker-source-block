...
- dashboard: qshopdemo_visitor_pulse_score_question_base
  title: "qshopdemo - Visitor Pulse - Score Question"
  extension: required
  layout: static
  tile_size: 10
  width: 1200
  ...
  - name: description
    ...
    model: qshopdemo_livetap
    explore: qshopdemo_qp_bi_visitor_pulse_v01
    title_text: "Visitor Pulse - Score Question"
    subtitle_text: ""
    body_text: "This report shows details of a selected score question (see FILTERS tab). Full survey response details can be found at the bottom of the dashboard. Hover over any chart, click the three dots icon and use Explore From Here to create your custom exploration using all Live Tap data."
  ...
  - name: average_score
    ...
    explore: qshopdemo_qp_bi_visitor_pulse_v01
    type: single_value
    fields: [qshopdemo_qp_bi_visitor_pulse_v01.average_score]
    filters:
      qshopdemo_qp_bi_visitor_pulse_v01.answer_score: NOT NULL
      qshopdemo_qp_bi_visitor_pulse_v01.question_type: score
    limit: 500
    column_limit: 50
  ...
  - name: nps
    ...
    explore: qshopdemo_qp_bi_visitor_pulse_v01
    type: single_value
    fields: [qshopdemo_qp_bi_visitor_pulse_v01.nps]
    filters:
      qshopdemo_qp_bi_visitor_pulse_v01.answer_score: NOT NULL
      qshopdemo_qp_bi_visitor_pulse_v01.question_type: score
    limit: 500
  ...
  - name: score_frequency
    ...
    top: 15
    left: 20
    title: 'Score answers frequency'
    model: qshopdemo_livetap
    explore: qshopdemo_qp_bi_visitor_pulse_v01
    type: looker_pie
    fields: [qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions, qshopdemo_qp_bi_visitor_pulse_v01.answer_score]
    filters:
      qshopdemo_qp_bi_visitor_pulse_v01.answer_score: NOT NULL
      qshopdemo_qp_bi_visitor_pulse_v01.question_type: score
    sorts: [qshopdemo_qp_bi_visitor_pulse_v01.answer_score]
    limit: 500
    column_limit: 50
    value_labels: labels
    label_type: labPer
  ...
  - name: score_over_time
    ...
    explore: qshopdemo_qp_bi_visitor_pulse_v01
    type: looker_column
    fields: [qshopdemo_qp_bi_visitor_pulse_v01.answer_score, qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions,
      qshopdemo_qp_bi_visitor_pulse_v01.time_data_points_week]
    pivots: [qshopdemo_qp_bi_visitor_pulse_v01.answer_score]
    fill_fields: [qshopdemo_qp_bi_visitor_pulse_v01.time_data_points_week]
    filters:
      qshopdemo_qp_bi_visitor_pulse_v01.question_type: score
      qshopdemo_qp_bi_visitor_pulse_v01.answer_score:  NOT NULL
    sorts: [qshopdemo_qp_bi_visitor_pulse_v01.answer_score, qshopdemo_qp_bi_visitor_pulse_v01.time_data_points_week
        desc]
    limit: 500
    stacking: normal
  ...
  - name: nps_over_time
    title: "Net Promoter Score over time"
    width: 100
    height: 40
    top: 95
    left: 20
    ...
    explore: qshopdemo_qp_bi_visitor_pulse_v01
    type: looker_area
    fields: [qshopdemo_qp_bi_visitor_pulse_v01.time_data_points_week, qshopdemo_qp_bi_visitor_pulse_v01.nps]
    fill_fields: [qshopdemo_qp_bi_visitor_pulse_v01.time_data_points_week]
    sorts: [qshopdemo_qp_bi_visitor_pulse_v01.time_data_points_week desc]
    limit: 1000
    column_limit: 50
    stacking: normal
    show_value_labels: false
