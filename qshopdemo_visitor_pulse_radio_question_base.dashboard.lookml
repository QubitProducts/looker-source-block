...
- dashboard: qshopdemo_visitor_pulse_radio_question_base
  ...
  elements:
    ...
    - name: description
      ...
      model: qshopdemo_livetap
      explore: qshopdemo_qp_bi_visitor_pulse_v01
      title_text: "Visitor Pulse - Radio Question"
      subtitle_text: ""
      body_text: "This report shows details of a selected radio question (see FILTERS tab). Full survey response details can be found at the bottom of the dashboard. Hover over any chart, click the three dots icon and use Explore From Here to create your custom exploration using all Live Tap data."
    ...
    - name: survey_visitors_radio_checkbox
      ...
      filters:
        ...
        qshopdemo_qp_bi_visitor_pulse_v01.question_type: radio
      limit: 500
      column_limit: 50
    ...
    - name: radio_checkbox_frequency
      ...
      filters:
        qshopdemo_qp_bi_visitor_pulse_v01.answer_radio_checkbox: "-NULL"
        qshopdemo_qp_bi_visitor_pulse_v01.question_type: radio
      sorts: [qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions desc]
      limit: 50
      column_limit: 50
      total: true
      row_total: right
    ...
    - name: radio_checkbox_over_time
      width: 100
      height: 45
      top: 60
      left: 20
      title: 'Radio / Checkbox responses over time'
      model: qshopdemo_livetap
      explore: qshopdemo_qp_bi_visitor_pulse_v01
      type: looker_column
      ...
      listen:
        ...
        user_survey_answer_3: qshopdemo_qp_bi_visitor_pulse_v01.user_survey_answer_3
      series_labels:
        1 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 1
        2 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 2
        3 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 3
        4 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 4
        5 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 5
        6 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 6
        7 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 7
        8 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 8
        9 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 9
        10 - qshopdemo_qp_bi_visitor_pulse_v01.total_answered_questions: Question 10
